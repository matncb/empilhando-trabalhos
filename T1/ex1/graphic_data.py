...
def plot_recusive_time():
    ...
    plt.savefig('graphics/fibonacci_recursive_times.png')
    plt.close()
...
def plot_iterative_time():
    ...
    plt.title('Fibonacci Iterative Execution Time')
    plt.legend()

    plt.savefig('graphics/fibonacci_iterative_times.png')
    plt.close()
...
def plot_normal_scale():
    ...
    plt.savefig('graphics/fibonacci_times.png')
    plt.close()
...
def plot_log_scale():
    ...
    plt.savefig('graphics/log_fibonacci_times.png')
    plt.close()
